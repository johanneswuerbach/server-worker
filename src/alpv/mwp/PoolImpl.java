...
public class PoolImpl<T> implements Pool<T>{
	...
	/**
	 * See {@link java.util.concurrent.ArrayBlockingQueue#put(T) ArrayBlockingQueue.put(T)}
	 */
	...
	/**
	 * See {@link java.util.concurrent.ArrayBlockingQueue#poll() ArrayBlockingQueue.poll()}
	 */
	...
	/**
	 * See {@link java.util.concurrent.ArrayBlockingQueue#size() ArrayBlockingQueue.size()}
	 */
